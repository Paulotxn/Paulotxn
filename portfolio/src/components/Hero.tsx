    ...
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 w-full">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          {/* Visual */}
          <div className="relative hidden lg:flex items-center justify-center fade-in delay-2">
            <div className="relative w-80 h-[420px]">
              ...
              <div className="absolute inset-6 bg-gradient-to-br from-gold/10 via-red-accent/5 to-transparent rounded-sm overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-black/30" />
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-32 h-32 rounded-full bg-gold/10 blur-[40px]" style={{ animation: "pulseGlow 4s ease-in-out infinite" }} />
              </div>
