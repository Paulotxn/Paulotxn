...
import { formacoes, type FormacaoItem } from "../data/portfolio";

const typeStyles: Record<FormacaoItem["type"], string> = {
      ...
      <div className="max-w-5xl mx-auto px-6">
        ...
        <div className="reveal mt-16 pt-8 border-t border-white/[0.05]">
          <p className="font-mono text-[10px] tracking-[0.2em] uppercase text-warm-gray/50 text-center">
            {formacoes.length} formações • 2014 – presente • Teatro, Dança & Técnica Cênica
          </p>
        </div>
      </div>
    </section>
