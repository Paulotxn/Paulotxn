        ...
        <div className="space-y-1 reveal-stagger">
          {espetaculos.map((item, i) => {
            ...
            return (
              ...
              >
                <div className={`relative p-5 md:p-6 rounded-sm border transition-all duration-500 ${isExpanded
                  ...
                  {/* Expanded content */}
                  <div className={`overflow-hidden transition-all duration-500 ease-out ${isExpanded ? "max-h-40 opacity-100 mt-4" : "max-h-0 opacity-0"
                    }`}>
                  ...
                  {/* Bottom line accent */}
                  <div className={`absolute bottom-0 left-0 h-[1px] bg-gradient-to-r from-gold/40 to-transparent transition-all duration-700 ${isExpanded ? "w-full" : "w-0 group-hover:w-1/3"
                    }`} />
                </div>
              </div>
            );
