export function Footer() {
  ...
  return (
    <footer className="relative py-20 lg:py-28 bg-darkest-bg" aria-label="Rodapé — Contato e informações">
      <div aria-hidden="true" className="absolute inset-x-0 top-0 h-[1px] bg-gradient-to-r from-transparent via-white/10 to-transparent" />
      ...
      <div className="max-w-5xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 mb-16">
          ...
          <InfoItem
            label="Contato"
            value="nicolirizzoli@gmail.com"
            href="mailto:nicolirizzoli@gmail.com"
          />
          <InfoItem
            label="Instagram"
            value="@nicolirizzoli"
...
function InfoItem({
  ...
  return (
    <div className="text-center sm:text-left">
      ...
      <Wrapper
        {...linkProps}
        className={`font-serif text-sm text-warm-gray/60 ${href ? "hover:text-gold transition-colors duration-300 cursor-pointer" : ""
          }`}
      >
        {value}
      </Wrapper>
