...
export function Hero() {
  ...
  const currentHeroImage = getImage("hero-profile");

  return (
    <section aria-label="Introdução" className="relative min-h-screen flex items-center overflow-hidden">
      {/* Ambient background */}
      <div aria-hidden="true" className="absolute inset-0">
        ...
        <div className="absolute top-1/4 right-1/4 w-[400px] h-[400px] rounded-full bg-red-accent/[0.04] blur-[100px]" style={{ animation: "float 8s ease-in-out infinite", willChange: "transform" }} />
        <div className="absolute bottom-1/4 left-1/3 w-[300px] h-[300px] rounded-full bg-gold/[0.03] blur-[80px]" style={{ animation: "float 10s ease-in-out infinite reverse", willChange: "transform" }} />
      </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="relative flex items-center justify-center fade-in delay-2">
            <div className="relative w-72 sm:w-80 h-[380px] sm:h-[420px]">
              ...
              {/* Corner accents */}
              <div aria-hidden="true" className="absolute top-0 left-0 w-6 h-[1px] bg-gold/40" />
              <div aria-hidden="true" className="absolute top-0 left-0 w-[1px] h-6 bg-gold/40" />
              <div aria-hidden="true" className="absolute bottom-0 right-0 w-6 h-[1px] bg-gold/40" />
              <div aria-hidden="true" className="absolute bottom-0 right-0 w-[1px] h-6 bg-gold/40" />
            </div>
          </div>
        </div>

        {/* Scroll hint */}
        <div aria-hidden="true" className="absolute bottom-10 left-1/2 -translate-x-1/2 flex flex-col items-center gap-3 fade-in delay-4">
      ...
      <div aria-hidden="true" className="absolute bottom-0 left-0 right-0 h-[1px] bg-gradient-to-r from-transparent via-white/10 to-transparent" />
    </section>
  );
}
